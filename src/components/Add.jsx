...
// youtube-embed :"https://www.youtube.com/embed/SqcY0GlETPk"
...
if(link.includes("v=")){
  ...
  const handleUpload =async ()=>{
    // sore upload video in localhost:3000/videos
    ...
    if(caption && imageURL && youtubeLink){
        ...
        if(result.status>=200 && result.status<300){
            alert(`video '${result.data.caption}' uploaded succcessfully!!!` )
    ...
    return (
        <>
            <div className="d-flex alighn-items-center">
                ...
                <button onClick={handleShow} className='btn bg-secondary ms-2'>
